...
import com.microtechmd.pda.library.entity.monitor.Battery;
...
public class DbHistory {
    ...
    public void setByteArray(byte[] byteArray) {
        ...
        try {
            ...
            setSensorIndex(dataInputStreamEvent.readByte());
            setEvent_type(dataInputStreamEvent.readByte() & 0x1F);
            ...
            setValue(dataInputStreamStatus.readShortLittleEndian());
